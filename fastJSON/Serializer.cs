...
namespace FastJSON
{
    internal sealed class Serializer
    {
        ...
        internal Serializer(Parameters param)
        {
            _params = param;
        ...
        private void WriteValue(object obj)
        {
            ...
            else if (_params.KVStyleStringDictionary == false && obj is IEnumerable<KeyValuePair<string, object>>)
                WriteStringDictionary((IEnumerable<KeyValuePair<string, object>>)obj);

            else if (_params.KVStyleStringDictionary == false && obj is IDictionary && obj.GetType().IsGenericType && Reflection.Instance.GetGenericArguments(obj.GetType())[0] == typeof(string))
        ...
        private Schema GetSchema(DataTable ds)
        {
        ...
        private Schema GetSchema(DataSet ds)
        {
            if (ds == null) return null;
